...
static exports *exports_records;//ACL控制文件读取加载内存数据结构
static char *ExportsFileName;//ACK配置文件  /etc/mfs/mfsexports.cfg
...
void exports_reload(void) {
	...
	if (!cfg_isdefined("EXPORTS_FILENAME")) {//ACL控制文件配置参数读取
