...
static datacache_entry dcm_tab[DCM_TAB_LENG];//哈希表的节点数据结构
static uint32_t dcm_inodehash[DCM_INODEHASH_LENG];//数据cache哈希表
static uint32_t dcm_lru_first,dcm_lru_last;//哈希表头和尾
